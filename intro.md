...
:class: dropdown
- [CRUMB: Efficient Prior Fitted Network Inference via Distributionally Matched Context Batching](https://arxiv.org/pdf/2606.11473) (2026): use MMD herding algorithm to improve performance of prior fitted networks. I helped with the implementation and experiments and co-devised the algorithm with Jamie. 
- [Entropy Distribution as a Fingerprint for Hallucinations in Generative Models](https://arxiv.org/pdf/2605.28264) (2026): a new method to detect hallucinations in generative models. I found the research direction and got amazing help to get this to work by my colleagues. 
